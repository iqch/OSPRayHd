...
//#include <OSPRayHD/renderDelegate.h>
#include <OSPRayHD/rendererPlugin.h>
...
private:
	...
	// renderer (e.g. OpenGL buffers, OSPRay scene objects). Each render

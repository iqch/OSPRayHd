	...
	HdDirtyBits *dirtyBits)
{
	if (*dirtyBits & DirtyDescription)
	{
		...
		// NO NEED WHILE NO THREAD static_cast<HdOSPRayRenderParam*>(renderParam)->AcquireSceneForEdit();
	}
...
HdOSPRayRenderBuffer::Finalize(HdRenderParam *renderParam)
{
	...
	// NO NEEDE WHILE NO THREAD static_cast<HdOSPRayRenderParam*>(renderParam)->AcquireSceneForEdit();

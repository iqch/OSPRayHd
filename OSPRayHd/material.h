...
public:
	...
	static OSPTextureFormat osprayTextureFormat(int depth, int channels, bool preferLinear = false);
	static OSPTexture LoadOIIOTexture2D(const char* file, bool nearestFilter = false);
protected:
